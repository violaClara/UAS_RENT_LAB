        ...
        <div class="container" data-layout="container">
            ...
            <nav class="navbar navbar-light navbar-vertical navbar-expand-xl" style="display: none;">
                ...
                <div class="d-flex align-items-center">
                    ...
                    </div><a class="navbar-brand" href="home_user">
                    ...
                    <div class="navbar-vertical-content scrollbar">
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link dropdown-indicator" href="#dashboard" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="dashboard">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span class="nav-link-text ps-1">Dashboard User</span>
                                    </div>
                                </a>
                                <ul class="nav collapse" id="dashboard">
                                    <li class="nav-item"><a class="nav-link" href="home_user">
                                        <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link" href="form_user_dosen">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-icon"><span class="fas fa-clipboard-list"></span></span>
                                        <span class="nav-link-text ps-1">Form Peminjaman Dosen/Staff Akademik</span>
                                    </div>
                                </a>
                                <a class="nav-link" href="form_user_mhs">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-icon"><span class="fas fa-clipboard-list"></span></span>
                                        <span class="nav-link-text ps-1">Form Peminjaman Mahasiswa</span>
                                    </div>
                                </a>
                            </li>
                        </ul>
                    ...
                    <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
                        ...
                        <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0"
                            ...
                            <div class="bg-white dark__bg-1000 rounded-2 py-2">
                                <a class="dropdown-item" href="landing_page">Logout</a>
                            </div>
                        </div>
                    </li>
                    </ul>
